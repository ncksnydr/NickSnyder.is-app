<header id="mainHeader">
  <nav class="container" aria-label="Global">
      ...
      <span class="sr-only">{{ $info->name->firstName }} {{ $info->name->lastName }}</span>
    ...
    <div id="desktopMenu" class="hidden lg:flex lg:gap-x-12">
      <a href="{{ $links->nav->projects }}" class="nav-item" target="_blank">Projects</a>
			...
			<div class="inline-flex relative">
				...
				<a href="{{ $links->social->linkedin }}" target="_blank" class="icon nav-icon">
				...
				<a href="{{ $links->social->github }}" target="_blank" class="icon nav-icon">
				...
				<a href="{{ $links->social->codepen }}" target="_blank" class="icon nav-icon">
				...
				<a href="{{ $links->social->dribbble }}" target="_blank" class="icon nav-icon">
