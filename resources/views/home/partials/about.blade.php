<!-- Testimonial section -->
    <div class="relative z-10 mt-32 bg-primary-900 pb-20 sm:mt-56 sm:pb-24 xl:pb-0">
        ...
        <svg viewBox="0 0 1097 1023" aria-hidden="true" class="absolute top-[calc(50%-36rem)] left-[calc(50%-19rem)] w-[68.5625rem] transform-gpu blur-3xl">
          ...
          <defs>
            <linearGradient id="a" x1="1097.04" x2="-173.036" y1=".267" y2="307.794" gradientUnits="userSpaceOnUse">
              <stop stop-color="{{ $globals->colors->tertiary }}" />
              <stop offset="1" stop-color="{{ $globals->colors->tertiary }}" />
            </linearGradient>
          </defs>
        </svg>
      </div>
      ...
      <div class="mx-auto flex max-w-7xl flex-col items-center gap-y-10 gap-x-8 px-6 sm:gap-y-8 lg:px-8 xl:flex-row xl:items-stretch">
        <div class="-mt-8 w-full max-w-2xl xl:-mb-8 xl:w-96 xl:flex-none">
          <div class="relative aspect-[2/1] h-full md:-mx-8 xl:mx-0 xl:aspect-auto">
            <img class="absolute inset-0 h-full w-full rounded-2xl bg-gray-800 object-cover shadow-2xl" src="{{ $about->image->url }}" alt="{{ $about->image->alt }}">
          </div>
        </div>
        <div class="w-full max-w-2xl xl:max-w-none xl:flex-auto xl:py-24 xl:px-16">
          <figure class="relative isolate pt-6 sm:pt-12">
            ...
            <figcaption class="mt-8 text-base">
              <div class="font-semibold text-white">{{ $globals->name->firstName }} {{ $globals->name->lastName }}</div>
            </figcaption>
          </figure>
        </div>
      </div>
